...
//
// NOTE: This file uses the .mjs extension specifically so Node.js always
// treats it as an ES module (import/export syntax), regardless of the
// "type" setting in package.json — which avoids the exact kind of
// require-vs-import mismatch error that broke the first version of this
// script.
