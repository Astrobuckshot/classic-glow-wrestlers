...
const WRESTLERS = [
  ...
  },
  {
    ...
    bio: "A kind if clueless 'high society' face, Tiffany Mellon teamed with best friend Roxy Astor as the Park Avenue Knockouts, bringing glamour and good-natured charm to the face faction of the roster — even accompanied to the ring by her butler Jeeves, showing off her glitz.",
  ...
  },
  {
    ...
    bio: "A bookish, nerdy underdog, Zelda used clever tactics to take on bigger opponents, often turning brains into advantage. Zelda showed off her wit in the ring by embarrassing Major Tanya in a game of chess — and proceeded to get smashed over the chess table by the Russian.",
